...
(function ($) {
    ...
    $.fn.jquizzy = function (settings) {
        ...
        var defaults = {
            ...
            endText: 'Finished!',
            splashImage: 'visuals/quiz/start.png',
            twitterImage: 'visuals/quiz/share.png',
        ...
        function judgeSkills(score) {
            ...
            else if (score > 35) return 'Bad';
            else if (score > 20) return 'Poor';
            else return 'Worst <br/>';
        }
        ...
        superContainer.find('.final').click(function () {
            ...
            shareButton = '<a href="http://twitter.com/share?text=' + config.twitterStatus.replace("{score}", score) + '&via=jQuizzy" class="share-button"><img src="' + config.twitterImage + '" /></a>';


            resultSet = '<h2 class="qTitle">' + judgeSkills(score) + '<br/>' + ' You scored ' + score + '%</h2>' + shareButton + resultSet + '<div class="jquizzy-clear"></div>';
